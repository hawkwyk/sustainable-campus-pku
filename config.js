...
const CONFIG = {
    ...
    projects: [
        ...
        },
        {
            ...
            year: '2025年',
            participants: '8人',
            description: '农园改造项目是北京大学可持续校园实践课程的重要成果之一。项目团队通过宣传设计和互动设计，将原本闲置的农园角落打造为宣传可持续行为宣传、推动可持续实践的宣传角。',
            details: [
                '设计理念：通过宣传和互动设计，让人们了解并尝试践行可持续生活方式',
                '内容涵盖：变废为宝（堆肥&软塑再生&核酸亭改造），与自然和谐相处（防鸟撞）',
                '宣传教育：开展光盘行动和节约粮食宣传'
            ],
            achievements: [
                '减少食物浪费50%',
