...
const CONFIG = {
    ...
    projects: [
        ...
        },
        {
            ...
            year: '2025年',
            participants: '8人',
            description: '农园食堂楼梯间改造项目是北京大学可持续校园实践课程聚焦校园环保生活的重要成果之一。项目团队通过利用原有设施打造“多元IP环保互动角”，并采用纸袋回收复用、激励游戏等方式，将食堂闲置空间转化为集环保实践和互动体验于一体的绿色宣传空间。',
            details: [
                '设计理念：以“趣味环保”和“可持续回收利用”为核心，通过IP文化元素吸引互动',
                '空间布局：划分入口引导区、右侧活动区、左侧奖品墙三大功能区：入口区：主题海报+云朵对话框营造沉浸式氛围；活动区：设纸袋收纳架、互动桌及游戏规则海报，进行回收与创意互动；奖品区：挂墙防尘袋存放IP贴纸等奖品，建立“回收-兑换”激励机制',
                '运营机制：投递1个干净纸袋可获小红花贴纸，累计对应数量兑换IP周边/环保制品；回收纸袋可随时供师生二次取用'
            ],
            achievements: [
                '实现校园纸袋循环利用率提升',
                '吸引师生参与环保实践',
        ...
        },
        {
            ...
            details: [
                ...
                '外部改造：经过刷漆、贴纸、门锁更换、孔洞填堵等步骤，核酸亭外观得到了较大程度的美化，曾经作为核酸亭的痕迹已基本消失',
                '内部改造：配备一张书桌、可调光阅读台灯、图书漂流书架、宣传可持续文化的墙饰、窗帘、防滑地垫、雨伞架等',
                '预约系统设计：为了方便核酸亭管理，设计了相应预约系统，过渡时期使用微信小程序',
            ],
            achievements: [
                '改造核酸亭5个',
                '节约建设成本70%',
            ...
            image: 'resources/project-booth.png',
